...
try {
    ...
    // URL dinámica basada en el origen de la petición (permite abrir desde celular con IPs como 192.168.x.x)
    $origin = $_SERVER['HTTP_ORIGIN'] ?? 'http://localhost:8100';
    $frontendUrl = rtrim($origin, '/') . "/#/reset-password?token=" . $token;
